...
namespace System.Web.Mvc
{
    ...
    {
        static ILog log = new Log4NetLogger(typeof(ViewExtensions));
    ...
    public static partial class HtmlExtension
    {
        ...
        {
            return WebCtrlManager.Instance.GetMenuStep(helper.ViewContext.RequestContext.HttpContext.Request.Url.ToString());
        }

        public static string GetPageLabel(this HtmlHelper helper)
        {
            return WebCtrlManager.Instance.GetPageLabel(helper.ViewContext.RequestContext.HttpContext.Request.Url.ToString());
        }
